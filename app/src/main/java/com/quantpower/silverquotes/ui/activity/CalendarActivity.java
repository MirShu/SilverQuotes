...
public class CalendarActivity extends Activity {
    ...
    private String webview = "http://m.dyhjw.com/rili/";
    private String jquery = "$('.side_menu_box').remove();" +
            "$('.huadong_box').remove();" +
            "$('.totop').remove();" +
            "$('.te_time').remove();" +
            "$('.footer').remove();";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.marketWebView = (WebView) findViewById(R.id.market_WebView);
...
//        this.iv_back_icon.setOnClickListener(v -> finish());
    ...
    private void showWebViewData() {
        ...
        lodingDialog = new CustomDialog(CalendarActivity.this, "加载中...");
        lodingDialog.show();
